...
public class ProcessoSeletivo {
    ...
    public static void main(String[] args) {
          ...
          String[] candidatos = {"MONICA", "FABRICIO", "MIRELA", "DANIELA", "JOSE"};
    ...
    //método auxiliar
    //Se o valor entre 1 e 3  for igual a 1, quer dizer que candidato atendeu
    ...
    System.out.println("Forma abreviada de iteracao usando for each: ");
      for (String candidato : candidatos) {
